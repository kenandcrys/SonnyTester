    ...
    return knex("products")
        ...
        .then(function () {
          return knex("subcategory").insert([
            ...
            //Men's Fashion
            { subcategory_name: "Men's Clothing", categoryId: 3 },
            { subcategory_name: "Men's Bags", categoryId: 3 },
            { subcategory_name: "Men's Shoes", categoryId: 3 },
            { subcategory_name: "Men's Jackets & Coats", categoryId: 3 },
            { subcategory_name: "Men's Accessories", categoryId: 3 },
            //Women's Fashion
            { subcategory_name: "Women's Tops", categoryId: 2 },
            { subcategory_name: "Women's Bottoms", categoryId: 2 },
            { subcategory_name: "Women's Dresses", categoryId: 2 },
            { subcategory_name: "Women's Jumpsuits", categoryId: 2 },
            { subcategory_name: "Women's Activewear", categoryId: 2 },
            { subcategory_name: "Women's Swimwear", categoryId: 2 },
            { subcategory_name: "Women's Bags", categoryId: 2 },
            { subcategory_name: "Women's Shoes", categoryId: 2 },
            { subcategory_name: "Women's Accessories", categoryId: 2 },
